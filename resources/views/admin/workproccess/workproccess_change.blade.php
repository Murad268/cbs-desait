...
<form enctype="multipart/form-data" action="{{route('admin.work__proccess.update', $proccess->id)}}" method="post">
    ...
    <div class="mb-3 form-group">
        ...
        <input value="{{old('proccess_title', $proccess->proccess_title)}}" name="proccess_title" type="text" class="form-control" placeholder="Enter name">
    ...
    <div class="mb-3 form-group">
        ...
        <input value="{{old('proccess_desc', $proccess->proccess_desc )}}" name="proccess_desc" type="text" class="form-control" placeholder="Enter name">
        @error('proccess_desc')
        <div class="alert alert-danger mt-2" role="alert">
            {{$message}}
        </div>
