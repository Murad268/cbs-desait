...
<form enctype="multipart/form-data" action="{{route('admin.header__banner.store')}}" method="post">
    ...
    <div class="mb-3 form-group">
        ...
        <input value="{{old('banner__title')}}" name="banner__title" type="text" class="form-control" placeholder="Enter name">
        @error('banner__title')
    ...
    <div class="mb-3 form-group">
        ...
        <input value="{{old('banner_subtitle')}}" name="banner_subtitle" type="text" class="form-control" placeholder="Enter name">
