...
<table class="table table-dark">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a target="_blank" href="{{asset('assets/front/images/'.$headerBannerItem->banner_img)}}">
                <img style="width: 150px; height: 50px" src="{{asset('assets/front/images/'.$headerBannerItem->banner_img)}}" alt="{{ $headerBannerItem->banner__title }}">
            </a>
