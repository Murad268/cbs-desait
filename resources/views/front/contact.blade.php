...
<section style="margin-top: 70px; width: 100%; height: 600px" class="map">
    <iframe style="width: 100%; height: 100%" src="{{$settings->map_link}}" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</section>
